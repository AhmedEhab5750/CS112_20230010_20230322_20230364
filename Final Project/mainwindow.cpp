    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->BlurSl->setVisible(false);
    ui->SkewSl->setVisible(false);
    ui->OilFast->setVisible(false);
    ui->OilSlow->setVisible(false);
}
...
void MainWindow::on_Crop_f8_clicked()
{
    ...
    if(X1 < image1.width && Y1 < image1.height && wdth + X1 < image1.width && hght + Y1 < image1.height){
...
void MainWindow::on_Resize_f11_clicked()
{
    ...
    if(name1 != ""){
        int wdth = QInputDialog::getInt(this, "Title", "Enter New Width:", 0);
        int hght = QInputDialog::getInt(this, "Title", "Enter New Height:", 0);
        resize_image_f11(image1, wdth, hght);
        image1.saveImage("temp.jpg");
        QString absolutePath = QDir::currentPath() + "/temp.jpg";
        QPixmap pix(absolutePath);
        ui->Picture->setPixmap(pix.scaled(400,200,Qt::KeepAspectRatio));
...
void MainWindow::on_Blur_f12_clicked()
{
    ...
    ui->OilSlow->setVisible(false);
    if(name1 != ""){
        ui->BlurSl->setVisible(true);
        image1.saveImage("temp.jpg");
    }
}

void MainWindow::on_BlurSl_sliderReleased()
{
    int sliderValue = ui->BlurSl->value();
    image1.loadNewImage("temp.jpg");
    boxBlur_f12(image1, sliderValue);
    image1.saveImage("temp1.jpg");
    QString absolutePath = QDir::currentPath() + "/temp1.jpg";
    QPixmap pix(absolutePath);
    ui->Picture->setPixmap(pix.scaled(400,200,Qt::KeepAspectRatio));
...
void MainWindow::on_OilPainting_f14_clicked()
{
    ...
    ui->OilSlow->setVisible(false);
    if(name1 != ""){
        ui->OilFast->setVisible(true);
        ui->OilSlow->setVisible(true);
    }

}

void MainWindow::on_OilFast_clicked()
{
    oilPaintingFilter_faster_f14(image1, 10, 100);
    image1.saveImage("temp.jpg");
    QString absolutePath = QDir::currentPath() + "/temp.jpg";
    QPixmap pix(absolutePath);
    ui->Picture->setPixmap(pix.scaled(400,200,Qt::KeepAspectRatio));
...
void MainWindow::on_OilSlow_clicked()
{
...
void MainWindow::on_Skew_f18_clicked()
{
    ...
    ui->OilSlow->setVisible(false);
    if(name1 != ""){
        ui->SkewSl->setVisible(true);
        image1.saveImage("temp.jpg");
    }
}

void MainWindow::on_SkewSl_sliderReleased()
{
    int sliderValue = ui->SkewSl->value();
    image1.loadNewImage("temp.jpg");
    skewImagealmostright_f18(image1, sliderValue);
    image1.saveImage("temp1.jpg");
    QString absolutePath = QDir::currentPath() + "/temp1.jpg";
    QPixmap pix(absolutePath);
    ui->Picture->setPixmap(pix.scaled(400,200,Qt::KeepAspectRatio));
